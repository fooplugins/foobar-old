  ...
  var fb = {
    ...
    googleApi: {
      ...
      load: {
        core: function() {
          ...
          var protocol = fb.settings.ssl ? 'https' : 'http';
          
          $('<script></script>')
            .attr('type', 'text/javascript')
            .attr('src', protocol + '://www.google.com/jsapi?callback=jQuery.foobarGoogleCallback')
            .appendTo('head');
        },
      ...
      fetch: {
        ...
        twitter: function() {
          ...
          var twitterRssUrl = 'http://api.twitter.com/1.1/statuses/user_timeline.rss?trim_user=0&screen_name=' + fb.settings.twitter.user;
    ...
    _render: {
      ...
      position: function() {
        ...
        fb.elements.main.wrapper.removeClass('fb-inline fb-top fb-bottom').addClass('fb-'+fb.settings.position.bar);
